...
- You MUST test against researched standards to ensure compliance
...
- You WILL consider the following tools and their usages (not limited to):
  ...
  - You WILL use `githubRepo` to research current conventions and best practices in relevant repositories
